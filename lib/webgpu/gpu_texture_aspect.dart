...
enum GPUTextureAspect {
  ...
  static GPUTextureAspect fromString(String s) {
    switch (s) {
      case 'all':
        return GPUTextureAspect.all;
      case 'stencil-only':
        return GPUTextureAspect.stencilOnly;
      case 'depth-only':
        return GPUTextureAspect.depthOnly;
    }
    throw Exception('Invalid value for GPUTextureAspect');
  }
